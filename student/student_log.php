...
<section class="text-gray-600 body-font">
    <div class="container py-24 mx-auto">
        <div class="flex flex-col sm:flex-row sm:items-center items-start mx-auto justify-around">
            <section>
                <img src="../images/image 1-3.png" alt="" class="h-72 animate-[bounce_9s_ease-in-out_infinite]">
            </section>
            <form method="POST" action="login_check.php" class="bg-gray-100 rounded-lg flex flex-col p-8 shadow-md shadow-gray-500/40">
                ...
                <div class=" mb-4 mt-6">
                    ...
                    <input type="text" id="e-id" name="username" class="w-full bg-white rounded border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" required>
                </div>
                <div class="mb-4">
                ...
                <p class="text-xs text-gray-500 mt-3 font-bold">Don’t have account ? <a href="./student_reg.php" class="text-indigo-700"> Register</a> Here. </p>
            </form>
            </div>
        </div>
</section>
