                            ...
                            <?php
                                ...
                                while ($leave_request = mysqli_fetch_assoc($result)) { ?>
                                    <tr>
                                        ...
                                        <td><?php echo $leave_request['sem']; echo '<sup>th</sup>' ?></td>
                                        <td>
                                            <?php $image = $leave_request['filename']; echo ' <img src="images/fees_report/'.$image.'" width="100px" height="100px" >' ?>
                                        </td>
