...
<header class="text-gray-600 body-font shadow-md shadow-gray-500/40">  
    <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        ...
        <nav class="md:ml-auto md:mr-auto flex flex-wrap items-center text-base justify-center">
            <h1 href="" class="text-center text-indigo-600 hover:text-violet-500 hover:cursor-pointer font-bold text-2xl">Welcome back Admin </h1>
        </nav>
    </div>
</header>
<section class="text-gray-600 body-font">
    <div class="container py-24 mx-auto">
        <div class="flex flex-col sm:flex-row sm:items-center items-start mx-auto justify-around">
            <section>
                <img src="../images/image 1-1.png" alt="" class="h-72 animate-[bounce_9s_ease-in-out_infinite]">
            </section>
            <form class="bg-gray-100 rounded-lg flex flex-col p-8 shadow-md shadow-gray-500/40" method="POST" action="login_check.php">
